...
const Sparkles = () => {
  const randomMove = () => 0; // Replace with a fixed value for SSR consistency
  const randomOpacity = () => 0.5; // Replace with a fixed value for SSR consistency
  const random = () => 0.5; // Replace with a fixed value for SSR consistency
  return (
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-xs w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "h-[8rem] md:h-[10rem] rounded-xl z-40",
        className,
        showGradient &&
